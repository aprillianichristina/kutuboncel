// Class untuk mengunduh Maven Wrapper jika belum ada di sistem
// Sumber: https://github.com/takari/maven-wrapper/blob/master/src/main/java/io/takari/maven/wrapper/MavenWrapperDownloader.java
...
public class MavenWrapperDownloader {
    ...
    public static void main(String args[]) {
        ...
        // Jika Maven Wrapper sudah ada, lewati pengunduhan
        if (isMavenWrapperAlreadyDownloaded(baseDirectory)) {
            System.out.println("Maven Wrapper - Already downloaded");
            return;
        }

        // Jika Maven Wrapper belum ada, unduh dari URL yang ditentukan
        try {
